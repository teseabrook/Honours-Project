...
void DiskMesh::initBuffers(ID3D11Device* device)
{
...
void DiskMesh::generateCircle(XMFLOAT3 centre, float radius, bool invert)
{
...
void DiskMesh::generateSides(int circle1Start)
{
	for (int i = 0; i < 360; i++)
	{
